...
def initialize_provider(app):
    ...
    #      - https://community.opengroup.org/osdu/platform/domain-data-mgmt-services/wellbore/wellbore-domain-services/-/blob/master/app/injector/aws_injector.py
    ...
    app.state.blob_storage = AwsStorage()
    ...
    raise NotImplementedError("aws initialization not implemented")
